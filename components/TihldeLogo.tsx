...
export function TihldeLogo({ size = "large" }: TihldeLogoProps) {
  const height = size === "large" ? 40 : 40;

  return (
    <svg
      className="block overflow-visible text-white"
      height={height}
    ...
    >
      <defs>
        <clipPath clipPathUnits="userSpaceOnUse" id="clipPath18">
          <path d="M 0,1005 H 1920 V 0 H 0 Z" />
        </clipPath>
      </defs>
      <g transform="matrix(1.3333333,0,0,-1.3333333,0,1340)">
        <g>
          <g clipPath="url(#clipPath18)">
            <g transform="translate(511.269,424.2549)">
              <path
            ...
            <g transform="translate(617.4761,526.4263)">
              <path
